...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        [btn setBackgroundImage:[UIImage imageNamed:@"circle" inBundle:selfBundle compatibleWithTraitCollection:NULL] forState:UIControlStateNormal];
        [btn setBackgroundImage:[UIImage imageNamed:@"close" inBundle:selfBundle compatibleWithTraitCollection:NULL] forState:UIControlStateSelected];
